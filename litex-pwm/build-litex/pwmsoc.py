...
class PWMSoC(SoCMini):
    SoCMini.mem_map["csr"] = 0x00000000
    def __init__(self, sys_clk_freq=int(100e6), **kwargs):

        # Add mockup pins to generate outputs of expected name
        arty._io += [("pwm", 0, Pins("mockup"), IOStandard("LVCMOS33"))]
        ...
        self.pwm0 = PWM(self.pwm0_o)

        self.submodules.pwm0 = self.pwm0

        self.add_csr('pwm0')

        self.comb += platform.request("pwm", 0).eq(self.pwm0_o)
